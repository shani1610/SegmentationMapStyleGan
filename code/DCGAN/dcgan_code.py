...
plotImages = True  #change to False when working on sipl computer
...
image = Image.open("./data/cities/cities_color/stuttgart03.png")
width_orig, height_orig = image.size # 2040 1016
...
class Generator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.main = nn.Sequential(
            ...
            # state size was 3 x 64 x 64
            # state size now is 3 x 128 x 64
            ...
            nn.BatchNorm2d(ngf),
            nn.ReLU(True),
            #try- #need to nfg*2 for all before?
            #nn.ConvTranspose2d(ngf, ngf, 4, 2, (1,2), bias=False),
            #nn.BatchNorm2d(ngf),
            #nn.ReLU(True),
            #end try
            ...
            # state size desired 3 x 128 x 64
        )
