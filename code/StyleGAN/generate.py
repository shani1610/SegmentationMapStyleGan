...
if __name__ == '__main__':
    ...
    #generator.load_state_dict(torch.load(args.path))#inbal change to this acording to the problem ffound on the internet
    generator.eval()
    ...
    #         #img, f'sample_mixing_{j}.png', nrow = 1, normalize = True, range = (-1, 1)
    #
    #     )
